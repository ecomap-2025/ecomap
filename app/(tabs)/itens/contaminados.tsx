...
export default function ContaminadosScreen() {
  ...
  return (
    <>
      <Stack.Screen options={{ headerShown: true, headerTransparent: true, headerTitle: '', headerShadowVisible: false }} />
      ...
      >
        <View style={{ width: '100%', height: height * 0.35, overflow: 'hidden' }}>
          <Image
