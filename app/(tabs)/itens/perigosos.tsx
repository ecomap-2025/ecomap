...
export default function PerigososScreen() {
  ...
  return (
    <ScrollView contentContainerStyle={{ flexGrow: 1, backgroundColor: fundo }}>
      <View style={{ width: '100%', height: height * 0.3, overflow: 'hidden' }}>
        <Image
          source={require('@/assets/imgs/perigosos.jpg')}
          style={{ width: '100%', height: '100%', resizeMode: 'cover', opacity: 0.8 }}
        />
      </View>

      <Text style={{ fontSize: width * 0.08, fontFamily: 'Poppins-Bold', color: '#e67e22', textAlign: 'center', marginTop: 15 }}>
        Perigosos
      </Text>
      ...
      <View style={{ marginHorizontal: 10, marginTop: 15 }}>
        ...
        <Text style={{ fontSize: width * 0.035, fontFamily: 'Poppins-Regular', color: texto, textAlign: 'justify', marginTop: 5 }}>
          Resíduos perigosos são materiais que, por suas características de inflamabilidade, corrosividade, toxicidade ou patogenicidade, apresentam risco à saúde e ao meio ambiente. Incluem itens como pilhas, baterias, lâmpadas fluorescentes, embalagens de agrotóxicos, resíduos hospitalares e produtos químicos vencidos.
        </Text>
      </View>
      ...
      <View style={{ marginHorizontal: 10, marginTop: 15, marginBottom: 50 }}>
        ...
        <Text style={{ fontSize: width * 0.035, fontFamily: 'Poppins-Regular', color: texto, textAlign: 'justify', marginTop: 5, lineHeight: 22 }}>
          ...
          {'\n\n'}
          <Text style={{ fontFamily: 'Poppins-Bold' }}>3. Pontos de Coleta Específicos:</Text> Leve os resíduos a locais de descarte apropriados. Supermercados e farmácias costumam recolher pilhas, baterias e medicamentos. Para outros itens, procure ecopontos ou consulte a prefeitura.
        </Text>
      </View>
    </ScrollView>
  );
